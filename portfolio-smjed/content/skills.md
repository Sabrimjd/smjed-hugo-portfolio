...
As a senior freelance <span class="key">SRE</span>, my work spans high-volume <span class="key">observability</span>, <span class="key">Kubernetes</span> platform operations, on-prem <span class="key">Proxmox/Ceph</span> infrastructure, and AI-assisted SRE tooling. The stack below reflects what I run in production today, alongside the infrastructure foundations that let me operate confidently across hybrid environments.

- **Observability & Reliability**: Grafana, Loki, Thanos, Vector, CloudWatch - SLO-oriented diagnostics and platform hygiene at scale
